...
var tokensCss = css`:host{--ds-auro-table-alt-row-container-color: var(--ds-color-container-secondary-default, #f7f7f7);--ds-auro-table-border-color: var(--ds-color-border-divider-default, rgba(0, 0, 0, 0.12))}`;
